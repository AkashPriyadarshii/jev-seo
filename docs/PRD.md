...
- **FR-7: Agent MCP Server (`mcp.rs`)**: Native stdio JSON-RPC 2.0 protocol for Claude Code and Gemini CLI exposing 8 tools (`seo_keywords`, `seo_serp_inspect`, `seo_audit`, `seo_geo`, `seo_schema`, `seo_robots`, `seo_brief`, `seo_sitemap`).
